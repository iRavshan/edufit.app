...
from .models import Question, Option, Attempt
...
def get_competition(request, competition_slug):
    competition = competitionRepository.get_by_slug(slug=competition_slug)
